let itemsContainerElement = document.querySelector('.items-cointanier');
itemsContainerElement.innerHTML = `<div class="item-cointanier">
                <img class="item-image" src="1.jpg" alt="item image">
                <div class="rating">
                    4.5 ⭐ | 1.4k
                </div>
